...
const CakeSize = (size: string, HandleSize: (e: any) => void) => {
  return (
    <div className="mt-75 mb-26 required">
      ...
      <InputToggle value={size} options={cakeSize} onChange={HandleSize} />
    </div>
  );
};
...
const CakeSheet = (
  ...
  return (
    <div className="mb-20 required">
      ...
      <InputToggle value={menu} options={cakeMenu} onChange={HandleMenu} />
      {menu === '직접 입력' && (
        <div className="mt-8">
          <Input
    ...
    <Main meta={<Meta title="Cakestation Review" description="리뷰 맛보기" />}>
      ...
      >
        <div className="w-85">
          ...
          {CakeSheet(menu, HandleMenu, HandleEtc)}
          {AdditionalOption()}
        </div>
      </Review>
    </Main>
